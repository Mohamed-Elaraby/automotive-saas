                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="me-3 flex-shrink-0">
                                        <img src="{{ asset('theme/img/icons/report-icon-01.svg')}}" alt="" class="low-stok-img">
                                    </div>
                                    <div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="card position-relative">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="me-3 flex-shrink-0">
                                        <img src="{{ asset('theme/img/icons/report-icon-02.svg')}}" alt="" class="low-stok-img">
                                    </div>
                                    <div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="card position-relative">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="me-3 flex-shrink-0">
                                        <img src="{{ asset('theme/img/icons/report-icon-03.svg')}}" alt="" class="low-stok-img">
                                    </div>
                                    <div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="card position-relative">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="me-3 flex-shrink-0">
                                        <img src="{{ asset('theme/img/icons/report-icon-04.svg')}}" alt="" class="low-stok-img">
                                    </div>
                                    <div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <a href="javascript:void(0);" class="avatar avatar-sm rounded-circle me-2 flex-shrink-0">
                                        <img src="{{ asset('theme/img/products/product-12.jpg')}}" class="rounded-circle" alt="img">
                                    </a>
                                    <div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <a href="javascript:void(0);" class="avatar avatar-sm rounded-circle me-2 flex-shrink-0">
                                        <img src="{{ asset('theme/img/products/product-13.jpg')}}" class="rounded-circle" alt="img">
                                    </a>
                                    <div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <a href="javascript:void(0);" class="avatar avatar-sm rounded-circle me-2 flex-shrink-0">
                                        <img src="{{ asset('theme/img/products/product-14.jpg')}}" class="rounded-circle" alt="img">
                                    </a>
                                    <div>
