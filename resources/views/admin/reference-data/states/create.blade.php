<?php $page = 'reference-states-create'; ?>
        ...
        <div class="content">
            <div class="page-header d-flex justify-content-between align-items-center flex-wrap gap-2">
                <div class="content-page-header">
                    <h5>Create State</h5>
                    <p class="text-muted mb-0">Add a state, governorate, emirate, or region.</p>
                </div>
            ...
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.reference-data.states.store') }}">
                        @csrf
