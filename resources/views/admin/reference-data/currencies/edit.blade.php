<?php $page = 'reference-currencies-edit'; ?>
        ...
        <div class="content">
            <div class="page-header d-flex justify-content-between align-items-center flex-wrap gap-2">
                <div class="content-page-header">
                    <h5>Edit Currency</h5>
                    <p class="text-muted mb-0">Update the selected currency reference record.</p>
                </div>
            ...
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.reference-data.currencies.update', $currency->id) }}">
                        @csrf
                        @method('PUT')
