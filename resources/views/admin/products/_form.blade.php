<div class="row g-3">
    ...
    <div class="col-md-3">
        ...
        <select name="is_active" class="form-select" required>
            <option value="1" @selected((int) old('is_active', $product->is_active ? 1 : 0) === 1)>Active</option>
            <option value="0" @selected((int) old('is_active', $product->is_active ? 1 : 0) === 0)>Inactive</option>
        </select>
