					...
					<div class="card position-relative">
						<div class="card-body">
							...
							<span class="position-absolute start-0 top-0">
								<img src="{{ asset('theme/img/bg/card-overlay-12.svg')}}" alt="">
							</span>
						</div> <!-- end card body -->
					</div> <!-- end card -->
				</div> <!-- end col -->
				...
				<div class="col-xl-3 col-lg-4 col-md-6">
					<div class="card position-relative">
						<div class="card-body">
							...
							<span class="position-absolute start-0 top-0">
								<img src="{{ asset('theme/img/bg/card-overlay-11.svg')}}" alt="">
							</span>
						</div> <!-- end card body -->
					</div> <!-- end card -->
				</div> <!-- end col -->
				...
				<div class="col-xl-3 col-lg-4 col-md-6">
					<div class="card position-relative">
						<div class="card-body">
							...
							<span class="position-absolute start-0 top-0">
								<img src="{{ asset('theme/img/bg/card-overlay-10.svg')}}" alt="">
							</span>
						</div> <!-- end card body -->
					</div> <!-- end card -->
				</div> <!-- end col -->
				...
				<div class="col-xl-3 col-lg-4 col-md-6">
					<div class="card position-relative">
						<div class="card-body">
							...
							<span class="position-absolute start-0 top-0">
								<img src="{{ asset('theme/img/bg/card-overlay-09.svg')}}" alt="">
							</span>
						</div> <!-- end card body -->
					</div> <!-- end card -->
				</div> <!-- end col -->
