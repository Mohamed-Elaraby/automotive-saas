    ...
    <section class="mkt-hero" style="padding-bottom:2.5rem;">
        <div class="mkt-container">
            <header class="mkt-section-head" style="margin-bottom:0;">
                <span class="mkt-eyebrow">{{ __('marketing.terms.last_updated') }}: {{ __('marketing.terms.last_updated_value') }}</span>
                <h1 class="mkt-h1" style="font-size:clamp(1.75rem,3.5vw,2.75rem);">{{ __('marketing.terms.h1') }}</h1>
            </header>
        </div>
    </section>
    ...
    <section class="mkt-section">
        <div class="mkt-container" style="max-width:900px;">
            <div class="mkt-card" style="display:grid;gap:1.5rem;">
                @foreach(trans('marketing.terms.sections') as $section)
                    <section>
