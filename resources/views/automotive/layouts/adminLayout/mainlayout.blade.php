...
@if(Route::is(['error-404', 'coming-soon', 'error-500', 'lock-screen', 'automotive/admin/login', 'success', 'two-step-verification', 'under-construction', 'under-maintenance', 'email-verification', 'forgot-password','free-trial','reset-password','register']))
