                    ...
                    <div class="card flex-fill">
                        ...
                        <div class="card-body">
                            <div class="d-grid gap-2">
                                ...
                                <a href="{{ route('automotive.admin.maintenance.approvals.index') }}" class="btn btn-outline-light text-start"><i class="isax isax-tick-circle me-2"></i>{{ __('maintenance.customer_approvals') }}</a>
                                <a href="{{ route('automotive.admin.maintenance.deliveries.index') }}" class="btn btn-outline-light text-start"><i class="isax isax-export-3 me-2"></i>{{ __('maintenance.deliveries') }}</a>
                                <a href="{{ route('automotive.admin.maintenance.warranties.index') }}" class="btn btn-outline-light text-start"><i class="isax isax-shield-search me-2"></i>{{ __('maintenance.warranties') }}</a>
                                <a href="{{ route('automotive.admin.maintenance.complaints.index') }}" class="btn btn-outline-light text-start"><i class="isax isax-message-question me-2"></i>{{ __('maintenance.complaints') }}</a>
                                <a href="{{ route('automotive.admin.maintenance.notifications.index') }}" class="btn btn-outline-light text-start"><i class="isax isax-notification me-2"></i>{{ __('maintenance.notifications') }}</a>
                                <a href="{{ route('automotive.admin.maintenance.documents.index') }}" class="btn btn-outline-light text-start"><i class="isax isax-document-text me-2"></i>{{ __('maintenance.documents.title') }}</a>
                                <a href="{{ route('automotive.admin.maintenance.reports.index') }}" class="btn btn-outline-light text-start"><i class="isax isax-chart-2 me-2"></i>{{ __('maintenance.reports.title') }}</a>
                                <a href="{{ route('automotive.admin.maintenance.fleet.index') }}" class="btn btn-outline-light text-start"><i class="isax isax-buildings me-2"></i>{{ __('maintenance.fleet.title') }}</a>
                                <a href="{{ route('automotive.admin.maintenance.advanced.index') }}" class="btn btn-outline-light text-start"><i class="isax isax-speedometer me-2"></i>{{ __('maintenance.advanced_operations') }}</a>
                                <a href="{{ route('automotive.admin.maintenance.integrations.index') }}" class="btn btn-outline-light text-start"><i class="isax isax-link-2 me-2"></i>{{ __('maintenance.integrations.title') }}</a>
                                <a href="{{ route('automotive.admin.maintenance.settings.index') }}" class="btn btn-outline-light text-start"><i class="isax isax-setting-2 me-2"></i>{{ __('maintenance.settings.title') }}</a>
