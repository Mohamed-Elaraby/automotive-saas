...
<head>
    ...
    <title>Create Inventory Adjustment</title>
    <style>
...
<div class="wrap">
    <div class="top">
        ...
        <a href="/automotive/admin/inventory-adjustments" class="btn btn-secondary">Back</a>
    </div>
    ...
    <div class="card">
        <form method="POST" action="/automotive/admin/inventory-adjustments">
            @csrf
