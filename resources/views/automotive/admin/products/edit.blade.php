...
<head>
    ...
    <style>
        ...
        input, textarea { width:100%; padding:10px 12px; border:1px solid #d1d5db; border-radius:8px; margin-top:6px; }
...
<div class="wrap">
    <div class="top">
        ...
        <a href="/automotive/admin/products" class="btn btn-secondary">Back</a>
    </div>
    ...
    <div class="card">
        <form method="POST" action="/automotive/admin/products/{{ $product->id }}">
            @csrf
            @method('PUT')

            @include('automotive.admin.products._form')
