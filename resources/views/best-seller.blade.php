                        ...
                        <div class="card position-relative">
                            <div class="card-body">
                                ...
                                <span class="position-absolute end-0 bottom-0">
                                    <img src="{{ asset('theme/img/bg/card-overlay-13.svg')}}" alt="User Img">
                                </span>
                            </div><!-- end card body -->
                        </div><!-- end card -->
                    </div><!-- end col -->
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="card position-relative">
                            <div class="card-body">
                                ...
                                <span class="position-absolute end-0 bottom-0">
                                    <img src="{{ asset('theme/img/bg/card-overlay-14.svg')}}" alt="User Img">
                                </span>
                            </div><!-- end card body -->
                        </div><!-- end card -->
                    </div><!-- end col -->
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="card position-relative">
                            <div class="card-body">
                                ...
                                <span class="position-absolute end-0 bottom-0">
                                    <img src="{{ asset('theme/img/bg/card-overlay-15.svg')}}" alt="User Img">
                                </span>
                            </div><!-- end card body -->
                        </div><!-- end card -->
                    </div><!-- end col -->
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="card position-relative">
                            <div class="card-body">
                                ...
                                <span class="position-absolute end-0 bottom-0">
                                    <img src="{{ asset('theme/img/bg/card-overlay-16.svg')}}" alt="User Img">
                                </span>
                            </div><!-- end card body -->
                        </div><!-- end card -->
                    </div><!-- end col -->
