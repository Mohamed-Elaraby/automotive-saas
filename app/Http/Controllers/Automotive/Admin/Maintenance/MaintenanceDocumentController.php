...
class MaintenanceDocumentController extends Controller
{
    ...
    public function generate(Request $request): RedirectResponse
    {
        $validated = $request->validate([
            'document_type' => ['required', 'in:maintenance_check_in,maintenance_work_order,maintenance_estimate,maintenance_delivery_report,maintenance_warranty_certificate'],
