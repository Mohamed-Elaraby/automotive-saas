...
class SystemErrorLogController extends Controller
{
    ...
    public function destroy(SystemErrorLog $systemError): RedirectResponse
    {
        $systemError->delete();

        return redirect()
            ->back()
            ->with('success', 'System error deleted successfully.');
    }
    ...
    public function destroyAll(Request $request): RedirectResponse
    {
        ...
        return redirect()
            ...
            ->with('success', "Deleted {$deletedCount} system error log(s) from the current view.");
    }
